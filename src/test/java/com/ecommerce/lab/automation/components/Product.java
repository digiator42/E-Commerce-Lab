...
public class Product {
    ...
    private final By category = By.xpath(".//span[last()]"); // The 'Sports' badge
    private final By description = By.cssSelector("p.text-gray-500");
    private final By addToCartBtn = By.xpath(".//button[contains(@onclick, 'cartManager.addItem')]");
    private final By wishlistBtn = By.xpath(".//button[contains(@onclick, 'wishlistManager.toggleItem')]");
    ...
    public String getCategoryValue() {
        return root.findElement(category).getText();
    }
    ...
    public void addToCart() {
        root.findElement(addToCartBtn).click();
    }

    public void toggleWishlist() {
        root.findElement(wishlistBtn).click();
    }
