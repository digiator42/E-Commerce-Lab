...
@Configuration
@EnableJpaRepositories(basePackages = "com.ecommerce.lab.repository.mysql", entityManagerFactoryRef = "mysqlEntityManagerFactory", transactionManagerRef = "mysqlTransactionManager")
